...
# export PYTHONPATH=/usr/local/Ascend/cann-9.0.0/aarch64-linux/include:$PYTHONPATH
# export PYTHONPATH=/usr/local/Ascend/cann-9.0.0/tools/profiler/profiler_tool/analysis/msmodel:$PYTHONPATH
...
export VLLM_LOG_STATS_INTERVAL=100.0
